    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        {buckets.length === 0 ? (
          ...
          <div className="hetzner-card rounded-lg p-8 text-center">
            ...
            <div className="space-y-4">
              <Link
                ...
                className="inline-flex items-center px-6 py-3 hetzner-btn-primary rounded-lg transition-colors duration-150 text-lg font-medium"
              >
                <Plus className="h-5 w-5 mr-2" />
                Add Your First Bucket
              </Link>
              <div className="text-sm hetzner-text-subtle">
          ...
          <div className="hetzner-card rounded-lg p-8 text-center">
            <Database className="h-16 w-16 hetzner-text-muted mx-auto mb-4" />
            <h2 className="text-2xl font-bold hetzner-text mb-2">Select a Bucket</h2>
            <p className="hetzner-text-muted mb-6 max-w-md mx-auto">
